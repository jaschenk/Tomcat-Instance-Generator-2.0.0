...
public class ValidationHelperTest {
    ...
    /**
     * Test the Validation of Ports
     */
    @Test
    public void test05() {
        assertFalse(ValidationHelper.validatePort(null));
        assertTrue(ValidationHelper.validatePort(18080));
        assertFalse(ValidationHelper.validatePort(-1));
        assertFalse(ValidationHelper.validatePort(1023));
        assertFalse(ValidationHelper.validatePort(65536));
        assertTrue(ValidationHelper.validatePort(1025));
        assertTrue(ValidationHelper.validatePort(65535));
    }

    /**
     * Test the Validation of Optional Ports
     */
    @Test
    public void test06() {
        assertTrue(ValidationHelper.validateOptionalPort(null));
        assertTrue(ValidationHelper.validatePort(18080));
        assertFalse(ValidationHelper.validatePort(-1));
        assertFalse(ValidationHelper.validatePort(1023));
        assertFalse(ValidationHelper.validatePort(65536));
