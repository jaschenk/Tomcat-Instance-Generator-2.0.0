...
public class ResourceHelper {
     ...
     */
    public static boolean persistFilteredResourceAsFile(Logger LOGGER, String resourceName, String destinationFilename,
        ...
        try {
             ...
             */
            return persistStringDataAsFile(LOGGER, fileContentsToFilter.toString(), destinationFilename);
        } catch (IOException e) {
     ...
     * @return boolean Indicator if the Method was successful or not.
     */
    public static boolean persistStringDataAsFile(Logger LOGGER, String contents, String destinationFilename) {
        try {
            /**
             * Output the new Filtered File...
             */
